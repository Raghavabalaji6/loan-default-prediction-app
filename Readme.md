...
This project predicts whether a loan applicant is likely to default using a Machine Learning model trained on historical financial data.
The application is built end-to-end — from data preprocessing and model training to a deployed Streamlit web app.
...
Banks face significant losses when loans are approved for high-risk customers.
The goal of this project is to identify risky borrowers early, prioritizing high recall so that most defaulters are correctly flagged.
